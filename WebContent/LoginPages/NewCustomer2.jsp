...
<%
    	String newUsername = request.getParameter("username");   
        	...
        	ArrayList<String> errors = new ArrayList<String>();
         	...
         	ArrayList<Customer> users = TrainProject.Customers.getAsList();
         	...
         	Customer newUser = new Customer(newUsername, newPassword,firstname, lastname, email);
        	TrainProject.Customers.insert(newUser);
